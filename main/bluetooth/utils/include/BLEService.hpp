...
private:
	...
	FreeRTOSInterface::Semaphore  m_semaphoreDeleteEvt = FreeRTOSInterface::Semaphore("DeleteEvt");
	FreeRTOSInterface::Semaphore  m_semaphoreStartEvt  = FreeRTOSInterface::Semaphore("StartEvt");
	FreeRTOSInterface::Semaphore  m_semaphoreStopEvt   = FreeRTOSInterface::Semaphore("StopEvt");
