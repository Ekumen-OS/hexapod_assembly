 ...
 */
void FreeRTOSInterface::sleep(uint32_t ms) {
 ...
 */
void FreeRTOSInterface::startTask(void task(void*), std::string taskName, void* param, uint32_t stackSize) {
 ...
 */
void FreeRTOSInterface::deleteTask(TaskHandle_t pTask) {
	::vTaskDelete(pTask);
} // deleteTask
 ...
 */
uint32_t FreeRTOSInterface::getTimeSinceStart() {
 ...
 */
uint32_t FreeRTOSInterface::Semaphore::wait(std::string owner) {
...
FreeRTOSInterface::Semaphore::Semaphore(std::string name) {
...
FreeRTOSInterface::Semaphore::~Semaphore() {
	if (m_usePthreads) {
 ...
 */
void FreeRTOSInterface::Semaphore::give() {
 ...
 */
void FreeRTOSInterface::Semaphore::give(uint32_t value) {
	m_value = value;
	give();
} // give
 ...
 */
void FreeRTOSInterface::Semaphore::giveFromISR() {
 ...
 */
bool FreeRTOSInterface::Semaphore::take(std::string owner) {
 ...
 * @return True if we took the semaphore.
 */
bool FreeRTOSInterface::Semaphore::take(uint32_t timeoutMs, std::string owner) {
 ...
 */
std::string FreeRTOSInterface::Semaphore::toString() {
 ...
 */
void FreeRTOSInterface::Semaphore::setName(std::string name) {
	m_name = name;
} // setName
